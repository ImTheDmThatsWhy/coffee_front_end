                ...
                {[...Array(5)].map((star, index) => {
                    ...
                    return(
                        <label key={index}>
                            ...
                            />  
                            <img className={`star ${currentRating <= (hover || rating) ? "star-active" : "star-inactive"}`}
                            src={Star}
                            size={50}
                            style={{
                                filter: currentRating <= (hover || rating) ? "invert(70%) sepia(84%) saturate(1200%) hue-rotate(358deg) brightness(105%) contrast(101%)" : "grayscale(100%)"
                            }}
                            onClick={() => setRating(currentRating)}
